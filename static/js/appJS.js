...
function uploadData (file) {
	...
	let parameters = { lang: "en", file: file, headers: { "Content-Type": "multipart/form-data" } };
	axios.post( "http://127.0.0.1:8010/transcribe/short", parameters ) .then(response => console.log(response)) .catch(error => { this.errorMessage = error.message; console.error("There was an error!", error); });
}
